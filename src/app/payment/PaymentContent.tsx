...
export default function PaymentContent() {
  ...
  const handlePayment = async () => {
    if (!formRef.current || !acceptTerms || !participantIdForPayment || amountInRupees === null) {
      toast({
    ...
    <div className="w-full max-w-md">
      <div className="flex items-center mb-6">
        <Link href="/register" passHref>
          <Button variant="ghost" size="icon" className="mr-2 text-foreground hover:bg-primary hover:text-primary-foreground">
        ...
        <CardContent>
          <form ref={formRef} className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              <Input id="coupon" name="coupon" type="text" value={coupon} onChange={(e) => setCoupon(e.target.value)} />
            </div>
            ...
            <div className="flex items-center space-x-2">
              ...
              <Label htmlFor="acceptTerms" className="text-sm font-medium leading-none">
                Accept Terms & Conditions <span className="text-destructive">*</span>
              </Label>
            </div>
            ...
            <Button
              ...
              disabled={isProcessing || amountInRupees === null}
              className="w-full bg-primary text-primary-foreground hover:bg-primary/90 text-lg py-3 rounded-md"
            >
              {isProcessing ? (
