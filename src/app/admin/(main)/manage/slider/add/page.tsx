...
export default function AddSliderItemPage() {
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center">
        ...
        <h1 className="text-3xl font-bold text-foreground">Add New Slider Item</h1>
      </div>

      <Card>
        <CardHeader>
          <CardTitle className="text-xl">New Slider Item Details</CardTitle>
          <CardDescription>
            Provide the title, image, and sort order for the new slider item.
          </CardDescription>
        </CardHeader>
        <CardContent>
